...
%hook YTInlinePlayerBarContainerView // Progress Bar - Old (Compatible for v17.33.2-v19.10.7)
- (id)quietProgressBarColor {
    return [UIColor colorWithRed:0.09 green:0.60 blue:1.00 alpha:1.0]; // STARDY cyan-blue
}
%end

%hook YTPlayerBarRectangleDecorationView // Progress Bar - New (Compatible for v19.10.7-latest)
